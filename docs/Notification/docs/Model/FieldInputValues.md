...
**error** | [**\FrankHouweling\AzureDevOpsClient\Notification\Model\InputValuesError**](InputValuesError.md) | Errors encountered while computing dynamic values. | [optional] 
...
**possibleValues** | [**\FrankHouweling\AzureDevOpsClient\Notification\Model\InputValue[]**](InputValue.md) | Possible values that this input can take | [optional] 
