...
**count** | **int** | Total number of matched wiki documents. | [optional] 
**results** | [**\AzureDevOpsClient\Search\AzureDevOpsClient\Search\Model\WikiResult[]**](WikiResult.md) | List of top matched wiki documents. | [optional] 
