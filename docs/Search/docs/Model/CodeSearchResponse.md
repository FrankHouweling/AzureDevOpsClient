...
**count** | **int** | Total number of matched files. | [optional] 
**results** | [**\AzureDevOpsClient\Search\AzureDevOpsClient\Search\Model\CodeResult[]**](CodeResult.md) | List of matched files. | [optional] 
