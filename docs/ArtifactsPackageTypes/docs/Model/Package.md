...
------------ | ------------- | ------------- | -------------
**links** | [**\FrankHouweling\AzureDevOpsClient\ArtifactsPackageTypes\Model\ReferenceLinks**](ReferenceLinks.md) | Related REST links. | [optional] 
...
**sourceChain** | [**\FrankHouweling\AzureDevOpsClient\ArtifactsPackageTypes\Model\UpstreamSourceInfo[]**](UpstreamSourceInfo.md) | The history of upstream sources for this package. The first source in the list is the immediate source from which this package was saved. | [optional] 
