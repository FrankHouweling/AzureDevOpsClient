...
------------ | ------------- | ------------- | -------------
**contribution** | [**\FrankHouweling\AzureDevOpsClient\Processes\Model\WitContribution**](WitContribution.md) | Contribution for the control. | [optional] 
...
**order** | **int** | Order in which the control should appear in its group. | [optional] 
