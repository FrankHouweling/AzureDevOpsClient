...
**deploymentInput** | [**\FrankHouweling\AzureDevOpsClient\Release\Model\MachineGroupDeploymentInput**](MachineGroupDeploymentInput.md) | Gets and sets the deployment group job input | [optional] 
