...
**parameters** | [**map[string,\AzureDevOpsClient\ServiceEndpoint\AzureDevOpsClient\ServiceEndpoint\Model\Parameter]**](Parameter.md) | Gets or sets parameters contained in configuration object. | [optional] 
