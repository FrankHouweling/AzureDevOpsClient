 ...
 *
 * @category Class
 * @description Defines a section of the work item form layout
 * @package  FrankHouweling\AzureDevOpsClient\Processes
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Section implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'groups' => '\FrankHouweling\AzureDevOpsClient\Processes\Model\Group[]',
        'id' => 'string',
        'overridden' => 'bool'
    ];
     ...
     * Sets groups
     *
     * @param \FrankHouweling\AzureDevOpsClient\Processes\Model\Group[] $groups List of child groups in this section
     *
     * @return $this
     */
