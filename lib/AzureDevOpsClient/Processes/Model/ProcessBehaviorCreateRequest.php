...
/**
 * ProcessBehaviorCreateRequest Class Doc Comment
 *
 * @category Class
 * @description Process Behavior Create Payload.
 * @package  FrankHouweling\AzureDevOpsClient\Processes
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProcessBehaviorCreateRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProcessBehaviorCreateRequest';
     ...
     * Sets inherits
     *
     * @param string $inherits Parent behavior id.
     *
     * @return $this
     */
     ...
     * Sets referenceName
     *
     * @param string $referenceName ReferenceName is optional, if not specified will be auto-generated.
     *
     * @return $this
     */
