...
/**
 * ProcessRule Class Doc Comment
 *
 * @category Class
 * @description Process Rule Response.
 * @package  FrankHouweling\AzureDevOpsClient\Processes
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProcessRule implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProcessRule';
    ...
    protected static $swaggerTypes = [
        'actions' => '\FrankHouweling\AzureDevOpsClient\Processes\Model\RuleAction[]',
        'conditions' => '\FrankHouweling\AzureDevOpsClient\Processes\Model\RuleCondition[]',
        'isDisabled' => 'bool',
        'name' => 'string',
     ...
     * Gets actions
     *
     * @return \FrankHouweling\AzureDevOpsClient\Processes\Model\RuleAction[]
     */
     ...
     * Sets actions
     *
     * @param \FrankHouweling\AzureDevOpsClient\Processes\Model\RuleAction[] $actions List of actions to take when the rule is triggered.
     *
     * @return $this
     */
     ...
     * Gets conditions
     *
     * @return \FrankHouweling\AzureDevOpsClient\Processes\Model\RuleCondition[]
     */
     ...
     * Sets conditions
     *
     * @param \FrankHouweling\AzureDevOpsClient\Processes\Model\RuleCondition[] $conditions List of conditions when the rule should be triggered.
     *
     * @return $this
     */
     ...
     * Sets isDisabled
     *
     * @param bool $isDisabled Indicates if the rule is disabled.
     *
     * @return $this
     */
     ...
     *
     * @param string $customizationType Indicates if the rule is system generated or created by user.
     *
     * @return $this
     */
     ...
     * Sets id
     *
     * @param string $id Id to uniquely identify the rule.
     *
     * @return $this
     */
