...
/**
 * ProcessWorkItemTypeField Class Doc Comment
 *
 * @category Class
 * @description Class that describes a field in a work item type and its properties.
 * @package  FrankHouweling\AzureDevOpsClient\Processes
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProcessWorkItemTypeField implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProcessWorkItemTypeField';
     ...
     * Sets allowedValues
     *
     * @param object[] $allowedValues The list of field allowed values.
     *
     * @return $this
     */
     ...
     * Sets customization
     *
     * @param string $customization Indicates the type of customization on this work item.
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param string $url Resource URL of the field.
     *
     * @return $this
     */
