...
/**
 * CreateProcessModel Class Doc Comment
 *
 * @category Class
 * @description Describes a process being created.
 * @package  FrankHouweling\AzureDevOpsClient\Processes
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateProcessModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateProcessModel';
     ...
     *
     * @param string $parentProcessTypeId The ID of the parent process
     *
     * @return $this
     */
     ...
     * Sets referenceName
     *
     * @param string $referenceName Reference name of process being created. If not specified, server will assign a unique reference name
     *
     * @return $this
     */
