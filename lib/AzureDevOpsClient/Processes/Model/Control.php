...
class Control implements ModelInterface, ArrayAccess
{
     ...
     * Sets contribution
     *
     * @param \FrankHouweling\AzureDevOpsClient\Processes\Model\WitContribution $contribution Contribution for the control.
     *
     * @return $this
     */
     ...
     * Sets order
     *
     * @param int $order Order in which the control should appear in its group.
     *
     * @return $this
     */
