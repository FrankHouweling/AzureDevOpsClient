 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WikiAttachmentResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WikiAttachmentResponse';
     ...
     * Sets eTag
     *
     * @param string[] $eTag Contains the list of ETag values from the response header of the attachments API call. The first item in the list contains the version of the wiki attachment.
     *
     * @return $this
     */
