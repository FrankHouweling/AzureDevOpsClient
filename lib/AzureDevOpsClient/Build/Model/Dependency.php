...
class Dependency implements ModelInterface, ArrayAccess
{
     ...
     * Sets event
     *
     * @param string $event The event. The dependency is satisfied when the referenced object emits this event.
     *
     * @return $this
     */
     ...
     * Sets scope
     *
     * @param string $scope The scope. This names the object referenced by the dependency.
     *
     * @return $this
     */
