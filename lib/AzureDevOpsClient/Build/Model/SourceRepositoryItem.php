...
/**
 * SourceRepositoryItem Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SourceRepositoryItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SourceRepositoryItem';
     ...
     * Sets isContainer
     *
     * @param bool $isContainer Whether the item is able to have sub-items (e.g., is a folder).
     *
     * @return $this
     */
     ...
     * Sets path
     *
     * @param string $path The full path of the item, relative to the root of the repository.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type The type of the item (folder, file, etc).
     *
     * @return $this
     */
