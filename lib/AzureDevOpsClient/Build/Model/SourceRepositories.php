 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SourceRepositories implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SourceRepositories';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['pageLength'] = isset($data['pageLength']) ? $data['pageLength'] : null;
     ...
     *
     * @param string $continuationToken A token used to continue this paged request; 'null' if the request is complete
     *
     * @return $this
     */
    ...
    {
        return $this->container['pageLength'];
    }

    /**
     * Sets pageLength
     *
     * @param int $pageLength The number of repositories requested for each page
     *
     * @return $this
     */
    public function setPageLength($pageLength)
    {
        $this->container['pageLength'] = $pageLength;
     ...
     * Sets totalPageCount
     *
     * @param int $totalPageCount The total number of pages, or '-1' if unknown
     *
     * @return $this
     */
