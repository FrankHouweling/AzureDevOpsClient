 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SourceRelatedWorkItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SourceRelatedWorkItem';
     ...
     * Sets currentState
     *
     * @param string $currentState Current state of the work item, e.g. Active, Resolved, Closed, etc.
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description Long description for the work item.
     *
     * @return $this
     */
     ...
     * Sets providerName
     *
     * @param string $providerName The name of the provider the work item is associated with.
     *
     * @return $this
     */
     ...
     * Sets title
     *
     * @param string $title Short name for the work item.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type Type of work item, e.g. Bug, Task, User Story, etc.
     *
     * @return $this
     */
