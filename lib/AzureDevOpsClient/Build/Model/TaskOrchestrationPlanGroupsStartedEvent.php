 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TaskOrchestrationPlanGroupsStartedEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TaskOrchestrationPlanGroupsStartedEvent';
    ...
    {
        $this->container['planGroups'] = isset($data['planGroups']) ? $data['planGroups'] : null;
    }
    ...
    {
        return $this->container['planGroups'];
    }
     ...
     * @return $this
     */
    public function setPlanGroups($planGroups)
    {
        $this->container['planGroups'] = $planGroups;
