...
/**
 * VariableMultipliersServerExecutionOptions Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VariableMultipliersServerExecutionOptions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VariableMultipliersServerExecutionOptions';
     ...
     *
     * @param bool $continueOnError Indicates whether failure of one job should prevent the phase from running in other jobs.
     *
     * @return $this
     */
     ...
     * Sets maxConcurrency
     *
     * @param int $maxConcurrency The maximum number of server jobs to run in parallel.
     *
     * @return $this
     */
