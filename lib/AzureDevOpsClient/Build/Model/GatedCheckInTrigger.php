...
/**
 * GatedCheckInTrigger Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GatedCheckInTrigger implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GatedCheckInTrigger';
    ...
    protected static $swaggerFormats = [
        'triggerType' => null,
        'pathFilters' => null,
        'runContinuousIntegration' => null,
        'useWorkspaceMappings' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'runContinuousIntegration' => 'runContinuousIntegration',
        'useWorkspaceMappings' => 'useWorkspaceMappings'
    ];
    ...
    protected static $setters = [
        ...
        'runContinuousIntegration' => 'setRunContinuousIntegration',
        'useWorkspaceMappings' => 'setUseWorkspaceMappings'
    ];
    ...
    protected static $getters = [
        ...
        'runContinuousIntegration' => 'getRunContinuousIntegration',
        'useWorkspaceMappings' => 'getUseWorkspaceMappings'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['runContinuousIntegration'] = isset($data['runContinuousIntegration']) ? $data['runContinuousIntegration'] : null;
        $this->container['useWorkspaceMappings'] = isset($data['useWorkspaceMappings']) ? $data['useWorkspaceMappings'] : null;
    }
    ...
    /**
     * Gets runContinuousIntegration
     *
     * @return bool
     */
    public function getRunContinuousIntegration()
    {
        return $this->container['runContinuousIntegration'];
    }

    /**
     * Sets runContinuousIntegration
     *
     * @param bool $runContinuousIntegration Indicates whether CI triggers should run after the gated check-in succeeds.
     *
     * @return $this
     */
    public function setRunContinuousIntegration($runContinuousIntegration)
    {
        $this->container['runContinuousIntegration'] = $runContinuousIntegration;

        return $this;
    }

    /**
     * Gets useWorkspaceMappings
     *
     * @return bool
     */
    public function getUseWorkspaceMappings()
    {
        return $this->container['useWorkspaceMappings'];
    }

    /**
     * Sets useWorkspaceMappings
     *
     * @param bool $useWorkspaceMappings Indicates whether to take workspace mappings into account when determining whether a build should run.
     *
     * @return $this
     */
    public function setUseWorkspaceMappings($useWorkspaceMappings)
    {
        $this->container['useWorkspaceMappings'] = $useWorkspaceMappings;
