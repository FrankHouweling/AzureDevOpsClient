...
/**
 * WorkItemTypeColorAndIcon Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WorkItemTypeColorAndIcon implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WorkItemTypeColorAndIcon';
     ...
     * Sets color
     *
     * @param string $color The color of the work item type in hex format.
     *
     * @return $this
     */
     ...
     * Sets icon
     *
     * @param string $icon The work item type icon.
     *
     * @return $this
     */
