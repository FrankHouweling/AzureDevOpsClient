...
/**
 * WorkItemFieldOperation Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WorkItemFieldOperation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WorkItemFieldOperation';
     ...
     * Sets name
     *
     * @param string $name Friendly name of the operation.
     *
     * @return $this
     */
     ...
     * Sets referenceName
     *
     * @param string $referenceName Reference name of the operation.
     *
     * @return $this
     */
