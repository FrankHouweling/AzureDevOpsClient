 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TokenAdminPagedSessionTokens implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TokenAdminPagedSessionTokens';
    ...
    protected static $swaggerTypes = [
        ...
        'value' => '\AzureDevOpsClient\TokenAdmin\AzureDevOpsClient\TokenAdmin\Model\SessionToken[]'
    ];
     ...
     *
     * @param string $continuationToken The continuation token that can be used to retrieve the next page of session tokens, or <code>null</code> if there is no next page.
     *
     * @return $this
     */
     ...
     * Gets value
     *
     * @return \AzureDevOpsClient\TokenAdmin\AzureDevOpsClient\TokenAdmin\Model\SessionToken[]
     */
     ...
     * Sets value
     *
     * @param \AzureDevOpsClient\TokenAdmin\AzureDevOpsClient\TokenAdmin\Model\SessionToken[] $value The list of all session tokens in the current page.
     *
     * @return $this
     */
