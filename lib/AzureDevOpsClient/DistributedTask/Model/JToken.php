...
class JToken implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'first' => '\FrankHouweling\AzureDevOpsClient\DistributedTask\Model\JToken',
        'hasValues' => 'bool',
        'item' => '\FrankHouweling\AzureDevOpsClient\DistributedTask\Model\JToken',
        'last' => '\FrankHouweling\AzureDevOpsClient\DistributedTask\Model\JToken',
        'next' => '\FrankHouweling\AzureDevOpsClient\DistributedTask\Model\JToken',
        'parent' => 'string',
        'path' => 'string',
        'previous' => '\FrankHouweling\AzureDevOpsClient\DistributedTask\Model\JToken',
        'root' => '\FrankHouweling\AzureDevOpsClient\DistributedTask\Model\JToken',
        'type' => 'string'
    ];
     ...
     * Sets first
     *
     * @param \FrankHouweling\AzureDevOpsClient\DistributedTask\Model\JToken $first Get the first child token of this token.
     *
     * @return $this
     */
     ...
     * Sets item
     *
     * @param \FrankHouweling\AzureDevOpsClient\DistributedTask\Model\JToken $item item
     *
     * @return $this
     */
     ...
     * Sets last
     *
     * @param \FrankHouweling\AzureDevOpsClient\DistributedTask\Model\JToken $last Get the last child token of this token.
     *
     * @return $this
     */
     ...
     * Sets next
     *
     * @param \FrankHouweling\AzureDevOpsClient\DistributedTask\Model\JToken $next Gets the next sibling token of this node.
     *
     * @return $this
     */
     ...
     * Sets previous
     *
     * @param \FrankHouweling\AzureDevOpsClient\DistributedTask\Model\JToken $previous Gets the previous sibling token of this node.
     *
     * @return $this
     */
     ...
     * Sets root
     *
     * @param \FrankHouweling\AzureDevOpsClient\DistributedTask\Model\JToken $root Gets the root JToken of this JToken.
     *
     * @return $this
     */
