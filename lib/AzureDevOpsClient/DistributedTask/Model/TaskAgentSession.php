...
/**
 * TaskAgentSession Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TaskAgentSession implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TaskAgentSession';
    ...
    protected static $swaggerTypes = [
        ...
        'encryptionKey' => '\FrankHouweling\AzureDevOpsClient\DistributedTask\Model\TaskAgentSessionKey',
        'ownerName' => 'string',
        'sessionId' => 'string',
     ...
     * Sets agent
     *
     * @param \FrankHouweling\AzureDevOpsClient\DistributedTask\Model\TaskAgentReference $agent Gets or sets the agent which is the target of the session.
     *
     * @return $this
     */
     ...
     * Gets encryptionKey
     *
     * @return \FrankHouweling\AzureDevOpsClient\DistributedTask\Model\TaskAgentSessionKey
     */
     ...
     * Sets encryptionKey
     *
     * @param \FrankHouweling\AzureDevOpsClient\DistributedTask\Model\TaskAgentSessionKey $encryptionKey Gets the key used to encrypt message traffic for this session.
     *
     * @return $this
     */
     ...
     * Sets ownerName
     *
     * @param string $ownerName Gets or sets the owner name of this session. Generally this will be the machine of origination.
     *
     * @return $this
     */
     ...
     * Sets sessionId
     *
     * @param string $sessionId Gets the unique identifier for this session.
     *
     * @return $this
     */
