 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PackageMetadata implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PackageMetadata';
    ...
    protected static $swaggerTypes = [
        ...
        'platform' => 'string',
        'type' => 'string',
        'version' => '\FrankHouweling\AzureDevOpsClient\DistributedTask\Model\PackageVersion'
    ];
     ...
     * Sets createdOn
     *
     * @param \DateTime $createdOn The date the package was created
     *
     * @return $this
     */
     ...
     * Sets downloadUrl
     *
     * @param string $downloadUrl A direct link to download the package.
     *
     * @return $this
     */
     ...
     * Sets filename
     *
     * @param string $filename The UI uses this to display instructions, i.e. \"unzip MyAgent.zip\"
     *
     * @return $this
     */
     ...
     * Sets hashValue
     *
     * @param string $hashValue MD5 hash as a base64 string
     *
     * @return $this
     */
     ...
     * Sets infoUrl
     *
     * @param string $infoUrl A link to documentation
     *
     * @return $this
     */
     ...
     * Sets platform
     *
     * @param string $platform The platform (win7, linux, etc.)
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type The type of package (e.g. \"agent\")
     *
     * @return $this
     */
     ...
     * Sets version
     *
     * @param \FrankHouweling\AzureDevOpsClient\DistributedTask\Model\PackageVersion $version The package version.
     *
     * @return $this
     */
