 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JobOption implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JobOption';
     ...
     * Sets id
     *
     * @param string $id Gets the id of the option.
     *
     * @return $this
     */
