...
class EndpointUrl implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'dependsOn' => '\FrankHouweling\AzureDevOpsClient\DistributedTask\Model\DependsOn',
        'displayName' => 'string',
        'helpText' => 'string',
        'isVisible' => 'string',
        'value' => 'string'
     ...
     * Gets dependsOn
     *
     * @return \FrankHouweling\AzureDevOpsClient\DistributedTask\Model\DependsOn
     */
     ...
     * Sets dependsOn
     *
     * @param \FrankHouweling\AzureDevOpsClient\DistributedTask\Model\DependsOn $dependsOn Gets or sets the dependency bindings.
     *
     * @return $this
     */
