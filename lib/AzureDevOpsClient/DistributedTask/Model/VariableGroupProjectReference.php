 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VariableGroupProjectReference implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VariableGroupProjectReference';
    ...
    protected static $swaggerTypes = [
        'description' => 'string',
        'name' => 'string',
        'projectReference' => '\FrankHouweling\AzureDevOpsClient\DistributedTask\Model\ProjectReference'
    ];
     ...
     *
     * @param \FrankHouweling\AzureDevOpsClient\DistributedTask\Model\ProjectReference $projectReference Gets or sets project reference of the variable group.
     *
     * @return $this
     */
