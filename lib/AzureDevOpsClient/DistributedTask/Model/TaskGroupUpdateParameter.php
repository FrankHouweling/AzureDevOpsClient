...
/**
 * TaskGroupUpdateParameter Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  FrankHouweling\AzureDevOpsClient\DistributedTask
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TaskGroupUpdateParameter implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TaskGroupUpdateParameter';
     ...
     * Sets comment
     *
     * @param string $comment Sets comment of the task group.
     *
     * @return $this
     */
     ...
     * Sets id
     *
     * @param string $id Sets the unique identifier of this field.
     *
     * @return $this
     */
     ...
     * Sets revision
     *
     * @param int $revision Sets revision of the task group.
     *
     * @return $this
     */
