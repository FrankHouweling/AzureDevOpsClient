 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RunFilter implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RunFilter';
     ...
     * Sets sourceFilter
     *
     * @param string $sourceFilter filter for the test case sources (test containers)
     *
     * @return $this
     */
     ...
     * Sets testCaseFilter
     *
     * @param string $testCaseFilter filter for the test cases
     *
     * @return $this
     */
