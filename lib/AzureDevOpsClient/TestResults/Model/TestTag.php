 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TestTag implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TestTag';
     ...
     * Sets name
     *
     * @param string $name Name of the tag, alphanumeric value less than 30 chars
     *
     * @return $this
     */
