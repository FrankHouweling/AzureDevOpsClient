...
class Hit implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['charOffset'] = isset($data['charOffset']) ? $data['charOffset'] : null;
    ...
    {
        return $this->container['charOffset'];
    }

    /**
     * Sets charOffset
     *
     * @param int $charOffset Gets or sets the start character offset of a piece of text.
     *
     * @return $this
     */
    public function setCharOffset($charOffset)
    {
        $this->container['charOffset'] = $charOffset;
     ...
     * Sets length
     *
     * @param int $length Gets or sets the length of a piece of text.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type Gets or sets the name of type of a piece of text.
     *
     * @return $this
     */
