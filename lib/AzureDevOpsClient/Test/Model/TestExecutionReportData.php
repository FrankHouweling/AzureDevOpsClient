 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TestExecutionReportData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TestExecutionReportData';
    ...
    {
        $this->container['reportData'] = isset($data['reportData']) ? $data['reportData'] : null;
    }
    ...
    {
        return $this->container['reportData'];
    }
    ...
    {
        $this->container['reportData'] = $reportData;
