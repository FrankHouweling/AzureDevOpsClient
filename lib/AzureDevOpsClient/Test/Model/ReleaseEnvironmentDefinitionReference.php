...
/**
 * ReleaseEnvironmentDefinitionReference Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReleaseEnvironmentDefinitionReference implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ReleaseEnvironmentDefinitionReference';
     ...
     * Sets definitionId
     *
     * @param int $definitionId ID of the release definition that contains the release environment definition.
     *
     * @return $this
     */
     ...
     *
     * @param int $environmentDefinitionId ID of the release environment definition.
     *
     * @return $this
     */
