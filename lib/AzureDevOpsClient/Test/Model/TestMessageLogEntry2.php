...
/**
 * TestMessageLogEntry2 Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  AzureDevOpsClient\Test
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TestMessageLogEntry2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TestMessageLogEntry2';
    ...
    public function setLogLevel($logLevel)
    {
        ...
        if (!is_null($logLevel) && (!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", $logLevel))) {
            throw new \InvalidArgumentException("invalid value for $logLevel when calling TestMessageLogEntry2., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.");
        }
