...
/**
 * TestParameter2 Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  FrankHouweling\AzureDevOpsClient\Test
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TestParameter2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TestParameter2';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['dataType']) && !preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", $this->container['dataType'])) {
            $invalidProperties[] = "invalid value for 'dataType', must be conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.";
        }
    ...
    public function setDataType($dataType)
    {
        ...
        if (!is_null($dataType) && (!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", $dataType))) {
            throw new \InvalidArgumentException("invalid value for $dataType when calling TestParameter2., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.");
        }
