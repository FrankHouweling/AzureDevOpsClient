 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PropertyBag implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PropertyBag';
     ...
     * Sets bag
     *
     * @param map[string,string] $bag Generic store for test session data
     *
     * @return $this
     */
