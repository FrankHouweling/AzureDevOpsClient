 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SuiteEntry implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SuiteEntry';
     ...
     * Sets childSuiteId
     *
     * @param int $childSuiteId Id of child suite in the test suite.
     *
     * @return $this
     */
     ...
     * Sets sequenceNumber
     *
     * @param int $sequenceNumber Sequence number for the test case or child test suite in the test suite.
     *
     * @return $this
     */
     ...
     * Sets suiteId
     *
     * @param int $suiteId Id for the test suite.
     *
     * @return $this
     */
     ...
     * Sets testCaseId
     *
     * @param int $testCaseId Id of a test case in the test suite.
     *
     * @return $this
     */
