 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TestResultsGroupsForBuild implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TestResultsGroupsForBuild';
     ...
     * Sets buildId
     *
     * @param int $buildId BuildId for which groupby result is fetched.
     *
     * @return $this
     */
