...
/**
 * PackageMetrics Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PackageMetrics implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PackageMetrics';
     ...
     * Sets downloadCount
     *
     * @param double $downloadCount Total count of downloads per package id.
     *
     * @return $this
     */
     ...
     *
     * @param double $downloadUniqueUsers Number of downloads per unique user per package id.
     *
     * @return $this
     */
     ...
     * Sets lastDownloaded
     *
     * @param \DateTime $lastDownloaded UTC date and time when package was last downloaded.
     *
     * @return $this
     */
