 ...
 *
 * @category Class
 * @description A layout node holding groups together in a page
 * @package  FrankHouweling\AzureDevOpsClient\ProcessDefinitions
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Section implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'groups' => '\FrankHouweling\AzureDevOpsClient\ProcessDefinitions\Model\Group[]',
        'id' => 'string',
        'overridden' => 'bool'
    ];
     ...
     * Sets groups
     *
     * @param \FrankHouweling\AzureDevOpsClient\ProcessDefinitions\Model\Group[] $groups groups
     *
     * @return $this
     */
