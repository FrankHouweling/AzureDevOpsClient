 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IdentityDescriptor implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IdentityDescriptor';
     ...
     * Sets identifier
     *
     * @param string $identifier The unique identifier for this identity, not exceeding 256 chars, which will be persisted.
     *
     * @return $this
     */
     ...
     * Sets identityType
     *
     * @param string $identityType Type of descriptor (for example, Windows, Passport, etc.).
     *
     * @return $this
     */
