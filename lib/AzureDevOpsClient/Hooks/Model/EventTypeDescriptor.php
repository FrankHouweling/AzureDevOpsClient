...
/**
 * EventTypeDescriptor Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EventTypeDescriptor implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EventTypeDescriptor';
     ...
     * Sets description
     *
     * @param string $description A localized description of the event type
     *
     * @return $this
     */
     ...
     * Sets id
     *
     * @param string $id A unique id for the event type
     *
     * @return $this
     */
     ...
     *
     * @param \FrankHouweling\AzureDevOpsClient\Hooks\Model\InputDescriptor[] $inputDescriptors Event-specific inputs
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name A localized friendly name for the event type
     *
     * @return $this
     */
     ...
     * Sets publisherId
     *
     * @param string $publisherId A unique id for the publisher of this event type
     *
     * @return $this
     */
     ...
     *
     * @param string[] $supportedResourceVersions Supported versions for the event's resource payloads.
     *
     * @return $this
     */
