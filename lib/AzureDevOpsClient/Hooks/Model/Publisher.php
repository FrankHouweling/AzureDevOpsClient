...
class Publisher implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'supportedEvents' => '\FrankHouweling\AzureDevOpsClient\Hooks\Model\EventTypeDescriptor[]',
        'url' => 'string'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['supportedEvents'] = isset($data['supportedEvents']) ? $data['supportedEvents'] : null;
     ...
     * Sets description
     *
     * @param string $description Gets this publisher's localized description.
     *
     * @return $this
     */
     ...
     * Sets id
     *
     * @param string $id Gets this publisher's identifier.
     *
     * @return $this
     */
     ...
     *
     * @param \FrankHouweling\AzureDevOpsClient\Hooks\Model\InputDescriptor[] $inputDescriptors Publisher-specific inputs
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Gets this publisher's localized name.
     *
     * @return $this
     */
     ...
     *
     * @param string $serviceInstanceType The service instance type of the first party publisher.
     *
     * @return $this
     */
    ...
    /**
     * Gets supportedEvents
     *
     * @return \FrankHouweling\AzureDevOpsClient\Hooks\Model\EventTypeDescriptor[]
     */
    public function getSupportedEvents()
    {
        return $this->container['supportedEvents'];
    }

    /**
     * Sets supportedEvents
     *
     * @param \FrankHouweling\AzureDevOpsClient\Hooks\Model\EventTypeDescriptor[] $supportedEvents Gets this publisher's supported event types.
     *
     * @return $this
     */
    public function setSupportedEvents($supportedEvents)
    {
        $this->container['supportedEvents'] = $supportedEvents;
