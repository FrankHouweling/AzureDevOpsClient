 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GraphGroup implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GraphGroup';
    ...
    protected static $swaggerTypes = [
        ...
        'originId' => 'string',
        'subjectKind' => 'string',
        'links' => '\AzureDevOpsClient\MemberEntitlementManagement\AzureDevOpsClient\MemberEntitlementManagement\Model\ReferenceLinks',
        'descriptor' => 'string',
        'displayName' => 'string',
        'url' => 'string',
        'description' => 'string'
     ...
     * Gets links
     *
     * @return \AzureDevOpsClient\MemberEntitlementManagement\AzureDevOpsClient\MemberEntitlementManagement\Model\ReferenceLinks
     */
     ...
     * Sets description
     *
     * @param string $description A short phrase to help human readers disambiguate groups with similar names
     *
     * @return $this
     */
