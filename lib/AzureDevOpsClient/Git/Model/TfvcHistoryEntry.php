 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TfvcHistoryEntry implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TfvcHistoryEntry';
     ...
     * Sets encoding
     *
     * @param int $encoding The encoding of the item at this point in history (only relevant for File history, not folders)
     *
     * @return $this
     */
     ...
     * Sets fileId
     *
     * @param int $fileId The file id of the item at this point in history (only relevant for File history, not folders)
     *
     * @return $this
     */
