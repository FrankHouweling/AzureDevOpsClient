 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TfvcItemPreviousHash implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TfvcItemPreviousHash';
    ...
    protected static $setters = [
        ...
        'path' => 'setPath',
        'url' => 'setUrl',
        'previousHashValue' => 'setPreviousHashValue'
    ];
    ...
    protected static $getters = [
        ...
        'path' => 'getPath',
        'url' => 'getUrl',
        'previousHashValue' => 'getPreviousHashValue'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['previousHashValue'] = isset($data['previousHashValue']) ? $data['previousHashValue'] : null;
    }
    ...
    /**
     * Gets previousHashValue
     *
     * @return string
     */
    public function getPreviousHashValue()
    {
        return $this->container['previousHashValue'];
    }

    /**
     * Sets previousHashValue
     *
     * @param string $previousHashValue MD5 hash as a base 64 string, applies to files only.
     *
     * @return $this
     */
    public function setPreviousHashValue($previousHashValue)
    {
        $this->container['previousHashValue'] = $previousHashValue;
