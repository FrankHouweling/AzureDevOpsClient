...
/**
 * FileDiffParams Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FileDiffParams implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FileDiffParams';
     ...
     * Sets originalPath
     *
     * @param string $originalPath Original path of the file
     *
     * @return $this
     */
     ...
     * Sets path
     *
     * @param string $path Current path of the file
     *
     * @return $this
     */
