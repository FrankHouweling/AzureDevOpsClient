...
/**
 * GitConflictRename2to1 Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GitConflictRename2to1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GitConflictRename2to1';
    ...
    protected static $swaggerTypes = [
        ...
        'url' => 'string',
        'resolution' => '\AzureDevOpsClient\Git\AzureDevOpsClient\Git\Model\GitResolutionPathConflict',
        'sourceNewBlob' => '\AzureDevOpsClient\Git\AzureDevOpsClient\Git\Model\GitBlobRef',
        'sourceOriginalBlob' => '\AzureDevOpsClient\Git\AzureDevOpsClient\Git\Model\GitBlobRef',
        'sourceOriginalPath' => 'string',
        'targetNewBlob' => '\AzureDevOpsClient\Git\AzureDevOpsClient\Git\Model\GitBlobRef',
        'targetOriginalBlob' => '\AzureDevOpsClient\Git\AzureDevOpsClient\Git\Model\GitBlobRef',
    ...
    protected static $swaggerFormats = [
        ...
        'resolution' => null,
        'sourceNewBlob' => null,
        'sourceOriginalBlob' => null,
        'sourceOriginalPath' => null,
        'targetNewBlob' => null,
        'targetOriginalBlob' => null,
    ...
    protected static $attributeMap = [
        ...
        'sourceNewBlob' => 'sourceNewBlob',
        'sourceOriginalBlob' => 'sourceOriginalBlob',
        'sourceOriginalPath' => 'sourceOriginalPath',
        'targetNewBlob' => 'targetNewBlob',
        'targetOriginalBlob' => 'targetOriginalBlob',
        'targetOriginalPath' => 'targetOriginalPath'
    ];
    ...
    protected static $setters = [
        ...
        'sourceNewBlob' => 'setSourceNewBlob',
        'sourceOriginalBlob' => 'setSourceOriginalBlob',
        'sourceOriginalPath' => 'setSourceOriginalPath',
        'targetNewBlob' => 'setTargetNewBlob',
        'targetOriginalBlob' => 'setTargetOriginalBlob',
        'targetOriginalPath' => 'setTargetOriginalPath'
    ];
    ...
    protected static $getters = [
        ...
        'sourceNewBlob' => 'getSourceNewBlob',
        'sourceOriginalBlob' => 'getSourceOriginalBlob',
        'sourceOriginalPath' => 'getSourceOriginalPath',
        'targetNewBlob' => 'getTargetNewBlob',
        'targetOriginalBlob' => 'getTargetOriginalBlob',
        'targetOriginalPath' => 'getTargetOriginalPath'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['sourceNewBlob'] = isset($data['sourceNewBlob']) ? $data['sourceNewBlob'] : null;
        $this->container['sourceOriginalBlob'] = isset($data['sourceOriginalBlob']) ? $data['sourceOriginalBlob'] : null;
        $this->container['sourceOriginalPath'] = isset($data['sourceOriginalPath']) ? $data['sourceOriginalPath'] : null;
        $this->container['targetNewBlob'] = isset($data['targetNewBlob']) ? $data['targetNewBlob'] : null;
        $this->container['targetOriginalBlob'] = isset($data['targetOriginalBlob']) ? $data['targetOriginalBlob'] : null;
        $this->container['targetOriginalPath'] = isset($data['targetOriginalPath']) ? $data['targetOriginalPath'] : null;
    }
     ...
     * Gets resolution
     *
     * @return \AzureDevOpsClient\Git\AzureDevOpsClient\Git\Model\GitResolutionPathConflict
     */
     ...
     * Sets resolution
     *
     * @param \AzureDevOpsClient\Git\AzureDevOpsClient\Git\Model\GitResolutionPathConflict $resolution resolution
     *
     * @return $this
     */
     ...
     */
    public function getSourceNewBlob()
    {
        return $this->container['sourceNewBlob'];
    }

    /**
     * Sets sourceNewBlob
     *
     * @param \AzureDevOpsClient\Git\AzureDevOpsClient\Git\Model\GitBlobRef $sourceNewBlob sourceNewBlob
     *
     * @return $this
     */
    public function setSourceNewBlob($sourceNewBlob)
    {
        $this->container['sourceNewBlob'] = $sourceNewBlob;

        return $this;
    }

    /**
     * Gets sourceOriginalBlob
     *
     * @return \AzureDevOpsClient\Git\AzureDevOpsClient\Git\Model\GitBlobRef
     */
    public function getSourceOriginalBlob()
    {
        return $this->container['sourceOriginalBlob'];
    }

    /**
     * Sets sourceOriginalBlob
     *
     * @param \AzureDevOpsClient\Git\AzureDevOpsClient\Git\Model\GitBlobRef $sourceOriginalBlob sourceOriginalBlob
     *
     * @return $this
     */
    public function setSourceOriginalBlob($sourceOriginalBlob)
    {
        $this->container['sourceOriginalBlob'] = $sourceOriginalBlob;

        return $this;
    }

    /**
     * Gets sourceOriginalPath
     *
     * @return string
     */
    public function getSourceOriginalPath()
    {
        return $this->container['sourceOriginalPath'];
    }

    /**
     * Sets sourceOriginalPath
     *
     * @param string $sourceOriginalPath sourceOriginalPath
     *
     * @return $this
     */
    public function setSourceOriginalPath($sourceOriginalPath)
    {
        $this->container['sourceOriginalPath'] = $sourceOriginalPath;
     ...
     * @return \AzureDevOpsClient\Git\AzureDevOpsClient\Git\Model\GitBlobRef
     */
    public function getTargetNewBlob()
    {
        return $this->container['targetNewBlob'];
    }

    /**
     * Sets targetNewBlob
     *
     * @param \AzureDevOpsClient\Git\AzureDevOpsClient\Git\Model\GitBlobRef $targetNewBlob targetNewBlob
     *
     * @return $this
     */
    public function setTargetNewBlob($targetNewBlob)
    {
        $this->container['targetNewBlob'] = $targetNewBlob;

        return $this;
    }

    /**
     * Gets targetOriginalBlob
     *
     * @return \AzureDevOpsClient\Git\AzureDevOpsClient\Git\Model\GitBlobRef
     */
    public function getTargetOriginalBlob()
    {
        return $this->container['targetOriginalBlob'];
    }

    /**
     * Sets targetOriginalBlob
     *
     * @param \AzureDevOpsClient\Git\AzureDevOpsClient\Git\Model\GitBlobRef $targetOriginalBlob targetOriginalBlob
     *
     * @return $this
     */
    public function setTargetOriginalBlob($targetOriginalBlob)
    {
        $this->container['targetOriginalBlob'] = $targetOriginalBlob;

        return $this;
    }

    /**
     * Gets targetOriginalPath
     *
     * @return string
     */
    public function getTargetOriginalPath()
    {
        return $this->container['targetOriginalPath'];
    }

    /**
     * Sets targetOriginalPath
     *
     * @param string $targetOriginalPath targetOriginalPath
     *
     * @return $this
     */
    public function setTargetOriginalPath($targetOriginalPath)
    {
        $this->container['targetOriginalPath'] = $targetOriginalPath;
