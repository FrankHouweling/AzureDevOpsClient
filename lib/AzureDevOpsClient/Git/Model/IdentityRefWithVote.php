 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IdentityRefWithVote implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IdentityRefWithVote';
    ...
    protected static $setters = [
        ...
        'reviewerUrl' => 'setReviewerUrl',
        'vote' => 'setVote',
        'votedFor' => 'setVotedFor'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['reviewerUrl'] = isset($data['reviewerUrl']) ? $data['reviewerUrl'] : null;
        $this->container['vote'] = isset($data['vote']) ? $data['vote'] : null;
        $this->container['votedFor'] = isset($data['votedFor']) ? $data['votedFor'] : null;
    }
     ...
     * Sets isFlagged
     *
     * @param bool $isFlagged Indicates if this reviewer is flagged for attention on this pull request.
     *
     * @return $this
     */
     ...
     * Sets isRequired
     *
     * @param bool $isRequired Indicates if this is a required reviewer for this pull request. <br /> Branches can have policies that require particular reviewers are required for pull requests.
     *
     * @return $this
     */
    ...
    {
        return $this->container['reviewerUrl'];
    }

    /**
     * Sets reviewerUrl
     *
     * @param string $reviewerUrl URL to retrieve information about this identity
     *
     * @return $this
     */
    public function setReviewerUrl($reviewerUrl)
    {
        $this->container['reviewerUrl'] = $reviewerUrl;
     ...
     * Sets vote
     *
     * @param int $vote Vote on a pull request:<br /> 10 - approved 5 - approved with suggestions 0 - no vote -5 - waiting for author -10 - rejected
     *
     * @return $this
     */
    ...
    {
        return $this->container['votedFor'];
    }
    ...
    {
        $this->container['votedFor'] = $votedFor;
