...
/**
 * NpmPackageVersionDeletionState Class Doc Comment
 *
 * @category Class
 * @description Deletion state of an npm package.
 * @package  FrankHouweling\AzureDevOpsClient\Governance
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NpmPackageVersionDeletionState implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NpmPackageVersionDeletionState';
     ...
     *
     * @param \DateTime $unpublishedDate UTC date the package was unpublished.
     *
     * @return $this
     */
