 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NotificationEventBacklogStatus implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NotificationEventBacklogStatus';
    ...
    protected static $setters = [
        'eventBacklogStatus' => 'setEventBacklogStatus',
        'notificationBacklogStatus' => 'setNotificationBacklogStatus'
    ];
    ...
    protected static $getters = [
        'eventBacklogStatus' => 'getEventBacklogStatus',
        'notificationBacklogStatus' => 'getNotificationBacklogStatus'
    ];
    ...
    {
        $this->container['eventBacklogStatus'] = isset($data['eventBacklogStatus']) ? $data['eventBacklogStatus'] : null;
        $this->container['notificationBacklogStatus'] = isset($data['notificationBacklogStatus']) ? $data['notificationBacklogStatus'] : null;
    }
    ...
    {
        return $this->container['eventBacklogStatus'];
    }
     ...
     * @return $this
     */
    public function setEventBacklogStatus($eventBacklogStatus)
    {
        $this->container['eventBacklogStatus'] = $eventBacklogStatus;
    ...
    {
        return $this->container['notificationBacklogStatus'];
    }
     ...
     * @return $this
     */
    public function setNotificationBacklogStatus($notificationBacklogStatus)
    {
        $this->container['notificationBacklogStatus'] = $notificationBacklogStatus;
