...
/**
 * NotificationEventFieldOperator Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NotificationEventFieldOperator implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NotificationEventFieldOperator';
     ...
     * Sets displayName
     *
     * @param string $displayName Gets or sets the display name of an operator
     *
     * @return $this
     */
     ...
     * Sets id
     *
     * @param string $id Gets or sets the id of an operator
     *
     * @return $this
     */
