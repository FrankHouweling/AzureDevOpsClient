...
/**
 * DataSourceBinding Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  FrankHouweling\AzureDevOpsClient\Release
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DataSourceBinding implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DataSourceBinding';
     ...
     * Sets endpointId
     *
     * @param string $endpointId Endpoint ID of the datasource.
     *
     * @return $this
     */
     ...
     * Sets endpointUrl
     *
     * @param string $endpointUrl Endpoint URL of the datasource.
     *
     * @return $this
     */
     ...
     * Sets parameters
     *
     * @param map[string,string] $parameters Parameters of the datasource.
     *
     * @return $this
     */
     ...
     * Sets resultSelector
     *
     * @param string $resultSelector Result selector applied on output of datasource result, for example jsonpath:$.value[?(@.properties.isEnabled == true)].
     *
     * @return $this
     */
     ...
     * Sets resultTemplate
     *
     * @param string $resultTemplate Format of the return results, for example. { \"Value\" : \"{{{id}}}\", \"DisplayValue\" : \"{{{name}}}\" }.
     *
     * @return $this
     */
     ...
     * Sets target
     *
     * @param string $target Target of the datasource.
     *
     * @return $this
     */
