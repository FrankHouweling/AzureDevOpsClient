...
/**
 * TaskboardColumnMapping Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TaskboardColumnMapping implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TaskboardColumnMapping';
     ...
     * Sets state
     *
     * @param string $state State of the work item type mapped to the column
     *
     * @return $this
     */
     ...
     * Sets workItemType
     *
     * @param string $workItemType Work Item Type name who's state is mapped to the column
     *
     * @return $this
     */
