...
/**
 * BacklogFields Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  AzureDevOpsClient\Work
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BacklogFields implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BacklogFields';
     ...
     * Sets typeFields
     *
     * @param map[string,string] $typeFields Field Type (e.g. Order, Activity) to Field Reference Name map
     *
     * @return $this
     */
