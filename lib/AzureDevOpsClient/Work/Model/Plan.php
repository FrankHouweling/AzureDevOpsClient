...
class Plan implements ModelInterface, ArrayAccess
{
    ...
    protected static $setters = [
        ...
        'id' => 'setId',
        'modifiedByIdentity' => 'setModifiedByIdentity',
    ...
    protected static $getters = [
        ...
        'id' => 'getId',
        'modifiedByIdentity' => 'getModifiedByIdentity',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['modifiedByIdentity'] = isset($data['modifiedByIdentity']) ? $data['modifiedByIdentity'] : null;
     ...
     * Sets createdDate
     *
     * @param \DateTime $createdDate Date when the plan was created
     *
     * @return $this
     */
    ...
    {
        return $this->container['modifiedByIdentity'];
    }
     ...
     * @return $this
     */
    public function setModifiedByIdentity($modifiedByIdentity)
    {
        $this->container['modifiedByIdentity'] = $modifiedByIdentity;
     ...
     * Sets modifiedDate
     *
     * @param \DateTime $modifiedDate Date when the plan was last modified. Default to CreatedDate when the plan is first created.
     *
     * @return $this
     */
     ...
     * Sets properties
     *
     * @param object $properties The PlanPropertyCollection instance associated with the plan. These are dependent on the type of the plan. For example, DeliveryTimelineView, it would be of type DeliveryViewPropertyCollection.
     *
     * @return $this
     */
     ...
     * Sets revision
     *
     * @param int $revision Revision of the plan. Used to safeguard users from overwriting each other's changes.
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param string $url The resource url to locate the plan via rest api
     *
     * @return $this
     */
