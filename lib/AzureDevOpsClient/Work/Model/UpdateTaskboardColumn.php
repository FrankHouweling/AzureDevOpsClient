 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateTaskboardColumn implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateTaskboardColumn';
     ...
     * Sets id
     *
     * @param string $id Column ID, keep it null for new column
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Column name is required
     *
     * @return $this
     */
