 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TeamSetting implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TeamSetting';
     ...
     *
     * @param map[string,bool] $backlogVisibilities Information about categories that are visible on the backlog.
     *
     * @return $this
     */
     ...
     * Sets bugsBehavior
     *
     * @param string $bugsBehavior BugsBehavior (Off, AsTasks, AsRequirements, ...)
     *
     * @return $this
     */
     ...
     *
     * @param string $defaultIterationMacro Default Iteration macro (if any)
     *
     * @return $this
     */
     ...
     * Sets workingDays
     *
     * @param object[] $workingDays Days that the team is working
     *
     * @return $this
     */
