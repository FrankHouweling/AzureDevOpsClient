...
/**
 * GraphUserOriginIdUpdateContext Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GraphUserOriginIdUpdateContext implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GraphUserOriginIdUpdateContext';
     ...
     * Sets originId
     *
     * @param string $originId This should be the object id or sid of the user from the source AD or AAD provider. Example: d47d025a-ce2f-4a79-8618-e8862ade30dd Azure Devops will communicate with the source provider to fill all other fields on creation.
     *
     * @return $this
     */
