 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GraphGroupMailAddressCreationContext implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GraphGroupMailAddressCreationContext';
     ...
     * Sets mailAddress
     *
     * @param string $mailAddress This should be the mail address or the group in the source AD or AAD provider. Example: jamal@contoso.com Team Services will communicate with the source provider to fill all other fields on creation.
     *
     * @return $this
     */
