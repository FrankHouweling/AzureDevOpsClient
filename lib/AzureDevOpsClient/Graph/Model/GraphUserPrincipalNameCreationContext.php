...
/**
 * GraphUserPrincipalNameCreationContext Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GraphUserPrincipalNameCreationContext implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GraphUserPrincipalNameCreationContext';
     ...
     * Sets principalName
     *
     * @param string $principalName This should be the principal name or upn of the user in the source AD or AAD provider. Example: jamal@contoso.com Team Services will communicate with the source provider to fill all other fields on creation.
     *
     * @return $this
     */
