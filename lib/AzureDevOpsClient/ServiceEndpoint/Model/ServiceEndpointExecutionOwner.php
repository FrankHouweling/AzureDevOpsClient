 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ServiceEndpointExecutionOwner implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ServiceEndpointExecutionOwner';
     ...
     * Sets id
     *
     * @param int $id Gets or sets the Id of service endpoint execution owner.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Gets or sets the name of service endpoint execution owner.
     *
     * @return $this
     */
