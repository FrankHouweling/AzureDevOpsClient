...
/**
 * ResultTransformationDetails Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ResultTransformationDetails implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResultTransformationDetails';
     ...
     *
     * @param string $callbackContextTemplate Gets or sets the template for callback parameters
     *
     * @return $this
     */
     ...
     *
     * @param string $callbackRequiredTemplate Gets or sets the template to decide whether to callback or not
     *
     * @return $this
     */
     ...
     * Sets resultTemplate
     *
     * @param string $resultTemplate Gets or sets the template for result transformation.
     *
     * @return $this
     */
