 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AcquisitionOptions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AcquisitionOptions';
    ...
    protected static $setters = [
        'defaultOperation' => 'setDefaultOperation',
        'itemId' => 'setItemId',
    ...
    {
        $this->container['defaultOperation'] = isset($data['defaultOperation']) ? $data['defaultOperation'] : null;
    ...
    {
        return $this->container['defaultOperation'];
    }
    ...
    {
        $this->container['defaultOperation'] = $defaultOperation;
     ...
     * Sets itemId
     *
     * @param string $itemId The item id that this options refer to
     *
     * @return $this
     */
     ...
     * Sets target
     *
     * @param string $target The target that this options refer to
     *
     * @return $this
     */
