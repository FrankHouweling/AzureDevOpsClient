 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UserExtensionPolicy implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserExtensionPolicy';
     ...
     * Sets displayName
     *
     * @param string $displayName User display name that this policy refers to
     *
     * @return $this
     */
     ...
     * Sets userId
     *
     * @param string $userId User id that this policy refers to
     *
     * @return $this
     */
