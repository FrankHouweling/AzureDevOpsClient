 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ClientContributionNode implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClientContributionNode';
     ...
     * Sets children
     *
     * @param string[] $children List of ids for contributions which are children to the current contribution.
     *
     * @return $this
     */
     ...
     * Sets parents
     *
     * @param string[] $parents List of ids for contributions which are parents to the current contribution.
     *
     * @return $this
     */
